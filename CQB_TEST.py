...
def cal_num(rcp_id):
    form = UserForm 
    print(form.check_sample.data)
     
    num_aodx = int(db.session.query(data.aodx_id).filter(data.rcp_id == rcp_id ).scalar())
#     # num_sample = int(db.session.query(data.sample_id).filter(data.rcp_id == rcp_id ).scalar())
#     # num_recipe = int(db.session.query(data.recipe_id).filter(data.rcp_id == rcp_id ).scalar())
   
#     # a = request.form.get("check_aodx")
#     # b = int(form.check_sample.data)
#     # c = request.form.get("check_recipe")
...
#     #     num_sample +=1
#     #     num_recipe +=1
#     #     rcp_lists = db.session.query.filter(data.rcp_id == rcp_id).all()
#     #     rcp_lists["AODX_ID"] = num_aodx
#     #     rcp_lists["SAMPLE_RULE_NUMBER"] = num_sample
#     #     rcp_lists["RECIPE_NUMBER"] = num_recipe
#     #     db.session.add(rcp_lists)
#     #     db.session.commit(rcp_lists)
        
#      return render_template("CQB_check.html")
